...
buttons = [
    [
        InlineKeyboardButton(
            text="⛩️ ꜱᴜᴍᴍᴏɴ ᴍᴇ ⛩️", url=f"t.me/{BOT_USERNAME}?startgroup=new"
        ),
    ],
    [
        InlineKeyboardButton(text=f"🍁 ʜᴇʟᴘ 🍁", callback_data="help_back"),
        InlineKeyboardButton(text=f"🔥 ꜱᴛᴀᴛꜱ 🔥", callback_data="stats_callback"),
    ],
    [
        InlineKeyboardButton(text="🌐 ᴀʙᴏᴜᴛꜱ 🌐", callback_data="ABG_"),
